...
class ReceiverNotifier extends _$ReceiverNotifier {
  ...
  Future<void> connectTo(String ip, int port) async {
    try {
      ...
      Logger.info('[DEBUG-RP] connectTo called: $ip:$port');
  ...
  Future<void> _handleSignalingMessageInternal(
    ...
    Logger.info('[DEBUG-RP] handleSignalingMessage: type=$type');
  ...
  Future<void> _handleOffer(Map<String, dynamic> data) async {
    try {
      ...
      Logger.info('[DEBUG-RP] _handleOffer CALLED, creating PeerConnection...');
      ...
      _webrtcService.onRemoteStream = (MediaStream stream) {
        ...
        Logger.info('[DEBUG-RP] onRemoteStream FIRED! stream id: ${stream.id}');
      ...
      if (answer != null) {
        ...
        Logger.info('[DEBUG-RP] Answer SENT to Sender');
      } else {
        Logger.error('Answer oluşturulamadı!');
        Logger.error('[DEBUG-RP] ERROR: Answer is NULL!');
      }
    } catch (e, st) {
