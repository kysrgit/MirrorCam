...
class WebRTCService {
  // ⚡ Bolt: Cache RegExp compilation to avoid redundant object creation in loops
  static final RegExp _profileLevelIdRegExp = RegExp(r'profile-level-id=[0-9a-fA-F]+');
